...
namespace TUKulinarium_API.Migrations
{
    ...
    [Migration("20240413191904_FinishedAuth")]
    partial class FinishedAuth
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TUKulinarium_API.Data.Models.Burger", b =>
                {
                    ...
                    b.Property<int>("BurgerBeverage")
                        .HasColumnType("int");

                    b.Property<int>("BurgerSide")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TUKulinarium_API.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TUKulinarium_API.Data.Models.PaymentInfo", b =>
                {
                    b.HasOne("TUKulinarium_API.Data.Models.UserProfile", null)
                        .WithMany("Payments")
                        .HasForeignKey("UserProfileProfileId");
                });
